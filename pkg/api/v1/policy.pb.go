...
func (*Policy) Descriptor() ([]byte, []int) {
	return fileDescriptor_policy_214dbc7d522d0b0a, []int{0}
}
...
func (*Rule) Descriptor() ([]byte, []int) {
	return fileDescriptor_policy_214dbc7d522d0b0a, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/supergloo/api/v1/policy.proto", fileDescriptor_policy_214dbc7d522d0b0a)
}

var fileDescriptor_policy_214dbc7d522d0b0a = []byte{
