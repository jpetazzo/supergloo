...
func (*Mesh) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_c9a236a96c4e7e48, []int{0}
}
...
func (*Istio) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_c9a236a96c4e7e48, []int{1}
}
...
func (*Linkerd2) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_c9a236a96c4e7e48, []int{2}
}
...
func (*Consul) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_c9a236a96c4e7e48, []int{3}
}
...
func (*AppMesh) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_c9a236a96c4e7e48, []int{4}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/supergloo/api/v1/mesh.proto", fileDescriptor_mesh_c9a236a96c4e7e48)
}

var fileDescriptor_mesh_c9a236a96c4e7e48 = []byte{
