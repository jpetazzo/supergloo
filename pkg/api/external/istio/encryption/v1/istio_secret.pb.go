...
func (*IstioCacertsSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_istio_secret_0034d0f1b5808721, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/supergloo/api/external/istio/encryption/v1/istio_secret.proto", fileDescriptor_istio_secret_0034d0f1b5808721)
}

var fileDescriptor_istio_secret_0034d0f1b5808721 = []byte{
